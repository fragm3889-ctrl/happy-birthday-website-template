...
export default function Celebration({ isOpened, onSequenceComplete }: CelebrationProps) {
        ...
        gsap.fromTo(
          ...
          { y: 100, opacity: 0, rotationX: -90 },
          {
            ...
            onComplete: () => {
              ...
              // Show the cat and scroll instruction after text finishes
              gsap.to(elementsRef.current, { autoAlpha: 1, y: 0, duration: 1, ease: "power2.out" });
              onSequenceComplete();
            }
          }
        );
  ...
  return (
    ...
    >
      ...
      {/* Interactive elements: Cat and Scroll prompt */}
      <div 
        ref={elementsRef} 
